...
* **Estruturas de dados:** Listas encadeadas, árvores, grafos. Em operações como inverter uma lista simplesmente encadeada, percorrer uma árvore em ordem, pós ordem ou pré ordem, achar caminhos em grafos, etc.
...
Este material contará com códigos em 5 linguagens de programação diferentes:
